...
# t1 = lineage_mutations('BA.2', server=test_server)
# t1.to_csv('test_one.csv')
# t1 = pd.read_csv('test_one.csv')

# val1 = lineage_mutations('BA.2', server=test_server)
# val1.to_csv('result_one.csv')
# val1 = pd.read_csv('result_one.csv')
# print(t1.equals(val1))


# t2 = lineage_mutations('BA.2 OR B.1.1.7', server=test_server)
# t2.to_csv('test_two.csv')
# t2 = pd.read_csv('test_two.csv')

# val2 = lineage_mutations('BA.2 OR B.1.1.7', server=test_server)
# val2.to_csv('result_two.csv')
# val2 = pd.read_csv('result_two.csv')
# print(t2.equals(val2))

# t3 = lineage_mutations('BA.2, B.1.1.7', server=test_server)
# t3.to_csv('test_three.csv')
# t3 = pd.read_csv('test_three.csv')

# val3 = lineage_mutations('BA.2, B.1.1.7', server=test_server)
# val3.to_csv('result_three.csv')
# val3 = pd.read_csv('result_three.csv')
# print(t1.equals(val1))

# t4 = lineage_mutations('BA.2','s:p681h', server=test_server)
# t4.to_csv('test_four.csv')
# t4 = pd.read_csv('test_four.csv')

# val4 = lineage_mutations('BA.2','s:p681h', server=test_server)
# val4.to_csv('result_four.csv')
# val4 = pd.read_csv('result_four.csv')
# print(t4.equals(val4))
